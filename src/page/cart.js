					...
					<div id="show">
						<div className="checkout_wrapper">
							...
							<div className="summary_container">
									 ...
									 <dl>
											<dt>
												<span className="product_num">商品数量总计: <strong id="productcount">1</strong> 件</span>商品金额（不含运费）:
											</dt>
									    <dd id="totalPrice">￥7980.00</dd>
									 </dl>
									 <dl id="disdl" className="hide">
										<dt><span className="vip"></span>会员折扣金额 :</dt>
										<dd id="discount">-￥0.00</dd>
									</dl>
                  <dl className="PT30">
										<dt>合计 :</dt>
										<dd className="price" id="totalamount">￥7980.00</dd>
									</dl>
									<dl className="pT10">
										<dt>&nbsp;</dt>
										<dd>
											<a className="btn btn_white btn_130" href="/home">继续购物</a>
											<button id="btnCheckOut" className="btn btn_gray btn_130 MR0" type="button" onClick={this.tap.bind(this)}>下一步</button>
										</dd>
							        </dl>
									<dl>
								      	<dd  style={{
